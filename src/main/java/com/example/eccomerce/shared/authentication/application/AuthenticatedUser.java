...
import com.example.eccomerce.shared.authentication.domain.Role;
import com.example.eccomerce.shared.authentication.domain.Roles;
import com.example.eccomerce.shared.authentication.domain.Username;
import com.example.eccomerce.shared.error.domain.Assert;
...
//check thông tin User khi người dùng đã đăng nhập
